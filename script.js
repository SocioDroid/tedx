...
let goalTime = new Date(
  document.querySelector("#counter-1").getAttribute("datetime")
);
...
function tick() {
  ...
  let newHour = formatTimeString(
    Math.floor((countdownTime % 86400000) / 3600000) + 4
  );
  let newMinute = formatTimeString(
    Math.floor(((countdownTime % 86400000) % 3600000) / 60000) + 30
  );
  let newSecond = formatTimeString(
    Math.floor((((countdownTime % 86400000) % 3600000) % 60000) / 1000)
  );
